...
module RBI
  module Rewriters
    ...
    # ~~~
    #
    # We can use `CleanTree` to remove the definitions found in the `index` from the `Tree` to clean:
    # ~~~rb
    ...
    # RBI
    #
    # cleaned_tree, operations = CleanTree.clean(tree_to_clean)
    #
